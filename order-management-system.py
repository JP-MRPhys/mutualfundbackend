...
class OrderManagementSystem:
    ...
    def _execute_sip_installment(self, sip_id, execution_date):
        ...
        lump_sum_order_id = self.place_lump_sum_order(
            sip_order['user_id'],
            sip_order['fund_code'],
            sip_order['amount'],
            'Buy'
...
if __name__ == "__main__":
    ...
    lump_sum_order_id = oms.place_lump_sum_order('USER001', 'HDFC001', 5000, 'Buy')
    print(f"Lump sum order placed: {lump_sum_order_id}")
